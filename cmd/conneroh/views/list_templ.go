...
func search(
	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		var templ_7745c5c3_Var12 = []any{twerge.It("w-full focus:outline-none border rounded-md pr-4 py-2 pl-10 bg-gray-700 text-white focus:ring-2 border-gray-600 focus:ring-green-500")}
		...
		var templ_7745c5c3_Var19 = []any{twerge.It("htmx-indicator top-2.5 text-green-500 absolute right-3")}
...
func ListResults(
	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		var templ_7745c5c3_Var33 = []any{twerge.It("grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 grid pt-2")}
