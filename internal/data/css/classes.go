...
var ClassMapStr = map[string]twerge.CacheValue{
	"-right-4 h-24 -bottom-4 rounded-full w-24 z-0 absolute bg-purple-600": twerge.CacheValue{
		Generated: "tw-26",
		Merged:    "rounded-full bg-purple-600 -right-4 h-24 w-24 z-0 absolute -bottom-4",
	},
	...
	"bg-gray-700 w-12 text-gray-300 justify-center hover:bg-gray-800 transition-colors rounded-full h-12 items-center flex": twerge.CacheValue{
		Generated: "tw-60",
		Merged:    "transition-colors flex bg-gray-700 w-12 text-gray-300 justify-center rounded-full hover:bg-gray-800 h-12 items-center",
	},
	...
	"bg-gray-800 p-8 rounded-lg space-y-6 shadow-md": twerge.CacheValue{
		Generated: "tw-62",
		Merged:    "space-y-6 p-8 rounded-lg shadow-md bg-gray-800",
	},
	...
	"bg-gray-800 rounded-lg mb-8 overflow-hidden p-6 shadow-lg": twerge.CacheValue{
		Generated: "tw-114",
		Merged:    "rounded-lg mb-8 p-6 bg-gray-800 overflow-hidden shadow-lg",
	},
	"bg-gray-800 transition-all flex transform hover:-translate-y-3 flex-col shadow-md rounded-lg hover:shadow-lg duration-300 overflow-hidden h-full cursor-pointer": twerge.CacheValue{
		Generated: "tw-112",
		Merged:    "hover:-translate-y-3 rounded-lg overflow-hidden hover:shadow-lg h-full cursor-pointer flex-col shadow-md flex duration-300 transition-all bg-gray-800 transform",
	},
	"bg-gray-800 transition-all flex transform hover:-translate-y-3 flex-col shadow-md rounded-lg hover:shadow-lg duration-300 overflow-hidden h-full": twerge.CacheValue{
		Generated: "tw-130",
		Merged:    "transform shadow-md rounded-lg bg-gray-800 transition-all flex hover:-translate-y-3 flex-col duration-300 overflow-hidden h-full hover:shadow-lg",
	},
	...
	"bg-gray-900 transition-all flex transform hover:-translate-y-3 flex-col shadow-md rounded-lg hover:shadow-lg duration-300 overflow-hidden h-full cursor-pointer": twerge.CacheValue{
		Generated: "tw-33",
		Merged:    "overflow-hidden transition-all cursor-pointer hover:-translate-y-3 duration-300 h-full transform shadow-md bg-gray-900 flex flex-col rounded-lg hover:shadow-lg",
	},
	...
	"bg-green-600 font-medium px-3 py-2 text-white rounded-md": twerge.CacheValue{
		Generated: "tw-94",
		Merged:    "bg-green-600 px-3 py-2 text-white font-medium rounded-md",
	},
	"bg-green-600 rounded-full p-4 w-16 h-16 flex items-center justify-center": twerge.CacheValue{
		Generated: "tw-141",
		Merged:    "w-16 p-4 flex items-center bg-green-600 justify-center rounded-full h-16",
	},
	...
	"container mx-auto lg:px-8 sm:px-6 px-4": twerge.CacheValue{
		Generated: "tw-2",
		Merged:    "lg:px-8 container mx-auto sm:px-6 px-4",
	},
	...
	"flex text-white justify-center inset-0 font-bold items-center absolute text-xl": twerge.CacheValue{
		Generated: "tw-24",
		Merged:    "flex justify-center inset-0 absolute text-white items-center font-bold text-xl",
	},
	...
	"font-medium border-gray-600 py-3 rounded-md px-6 text-gray-300 transition-colors hover:bg-gray-800 border": twerge.CacheValue{
		Generated: "tw-21",
		Merged:    "px-6 hover:bg-gray-800 py-3 rounded-md border border-gray-600 font-medium transition-colors text-gray-300",
	},
	...
	"h-12 transition-colors justify-center rounded-full text-gray-300 bg-gray-700 flex w-12 items-center hover:bg-red-500": twerge.CacheValue{
		Generated: "tw-61",
		Merged:    "hover:bg-red-500 h-12 rounded-full justify-center text-gray-300 bg-gray-700 flex w-12 items-center transition-colors",
	},
	"h-24 w-24 rounded-full bg-red-500 flex items-center justify-center": twerge.CacheValue{
		Generated: "tw-103",
		Merged:    "w-24 items-center h-24 justify-center flex rounded-full bg-red-500",
	},
	...
	"hover:bg-green-400 w-12 rounded-full bg-gray-700 transition-colors flex text-gray-300 h-12 items-center justify-center": twerge.CacheValue{
		Generated: "tw-59",
		Merged:    "rounded-full transition-colors text-gray-300 h-12 items-center w-12 bg-gray-700 flex justify-center hover:bg-green-400",
	},
	...
	"htmx-indicator top-2.5 text-green-500 absolute right-3": twerge.CacheValue{
		Generated: "tw-85",
		Merged:    "htmx-indicator right-3 top-2.5 text-green-500 absolute",
	},
	"inline-flex items-center justify-center px-6 py-3 border border-gray-700 rounded-md shadow-sm text-base font-medium text-gray-300 bg-gray-900 hover:bg-gray-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500": twerge.CacheValue{
		Generated: "tw-110",
		Merged:    "hover:bg-gray-700 items-center font-medium text-gray-300 focus:ring-gray-500 px-6 inline-flex justify-center py-3 border-gray-700 rounded-md text-base shadow-sm transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 bg-gray-900 border",
	},
	"inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-green-600 hover:bg-green-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500": twerge.CacheValue{
		Generated: "tw-109",
		Merged:    "transition-colors focus:ring-2 px-6 text-white inline-flex border rounded-md shadow-sm font-medium bg-green-600 py-3 border-transparent focus:outline-none items-center focus:ring-offset-2 text-base hover:bg-green-700 focus:ring-green-500 justify-center",
	},
	...
	"max-w-md w-full bg-gray-800 rounded-lg shadow-lg overflow-hidden": twerge.CacheValue{
		Generated: "tw-101",
		Merged:    "bg-gray-800 rounded-lg w-full shadow-lg overflow-hidden max-w-md",
	},
	...
	"mb-3 text-xl hover:underline font-semibold text-white line-clamp-2": twerge.CacheValue{
		Generated: "tw-37",
		Merged:    "text-xl line-clamp-2 mb-3 hover:underline font-semibold text-white",
	},
	...
	"mb-4 md:text-5xl text-4xl leading-tight font-bold lg:text-6xl text-white": twerge.CacheValue{
		Generated: "tw-16",
		Merged:    "mb-4 text-4xl lg:text-6xl md:text-5xl leading-tight font-bold text-white",
	},
	...
	"min-h-screen flex items-center justify-center bg-gray-900 px-4 py-12": twerge.CacheValue{
		Generated: "tw-100",
		Merged:    "min-h-screen items-center justify-center bg-gray-900 px-4 flex py-12",
	},
	...
	"mt-8 pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center": twerge.CacheValue{
		Generated: "tw-75",
		Merged:    "border-gray-700 flex flex-col items-center pt-8 md:flex-row justify-between mt-8 border-t",
	},
	...
	"mx-auto rounded-full h-64 bg-blue-600 relative md:w-80 md:h-80 w-64 shadow-lg": twerge.CacheValue{
		Generated: "tw-23",
		Merged:    "bg-blue-600 md:h-80 shadow-lg mx-auto h-64 md:w-80 rounded-full relative w-64",
	},
	...
	"overflow-hidden bg-gray-800 transform rounded-lg transition-all hover:shadow-lg duration-300 shadow-md hover:-translate-y-1 cursor-pointer": twerge.CacheValue{
		Generated: "tw-47",
		Merged:    "transition-all shadow-md hover:shadow-lg duration-300 cursor-pointer rounded-lg hover:-translate-y-1 overflow-hidden bg-gray-800 transform",
	},
	"p-2 focus:outline-none sm:hidden hover:text-white hover:bg-gray-700 rounded-md text-gray-300 mr-2": twerge.CacheValue{
		Generated: "tw-5",
		Merged:    "p-2 hover:bg-gray-700 focus:outline-none hover:text-white rounded-md text-gray-300 mr-2 sm:hidden",
	},
	...
	"p-6 rounded-lg overflow-hidden bg-gray-800 shadow-md hover:shadow-lg duration-300 transform transition-all hover:-translate-y-1 cursor-pointer": twerge.CacheValue{
		Generated: "tw-113",
		Merged:    "duration-300 transition-all p-6 hover:-translate-y-1 cursor-pointer rounded-lg hover:shadow-lg transform overflow-hidden shadow-md bg-gray-800",
	},
	"p-6 rounded-lg overflow-hidden bg-gray-900 shadow-md hover:shadow-lg duration-300 transform transition-all hover:-translate-y-1": twerge.CacheValue{
		Generated: "tw-52",
		Merged:    "hover:-translate-y-1 p-6 rounded-lg bg-gray-900 transition-all transform duration-300 shadow-md overflow-hidden hover:shadow-lg",
	},
	...
	"px-2 text-gray-200 bottom-0 py-1 right-0 text-xs rounded-tl-md bg-blue-500 absolute": twerge.CacheValue{
		Generated: "tw-43",
		Merged:    "right-0 bg-blue-500 bottom-0 py-1 text-xs rounded-tl-md absolute px-2 text-gray-200",
	},
	"px-3 bg-gray-800 transition-colors rounded-md border py-2 border-gray-700 text-gray-300 hover:bg-gray-700 flex items-center": twerge.CacheValue{
		Generated: "tw-98",
		Merged:    "hover:bg-gray-700 flex items-center border rounded-md px-3 border-gray-700 text-gray-300 py-2 bg-gray-800 transition-colors",
	},
	"px-3 bg-gray-800 transition-colors rounded-md border py-2 border-gray-700 text-gray-300 hover:bg-gray-700 opacity-50 flex items-center": twerge.CacheValue{
		Generated: "tw-92",
		Merged:    "bg-gray-800 border hover:bg-gray-700 items-center rounded-md flex transition-colors text-gray-300 px-3 opacity-50 py-2 border-gray-700",
	},
	"px-3 bg-gray-800 transition-colors rounded-md border py-2 border-gray-700 text-gray-300 hover:bg-gray-700": twerge.CacheValue{
		Generated: "tw-95",
		Merged:    "border text-gray-300 hover:bg-gray-700 rounded-md bg-gray-800 border-gray-700 py-2 px-3 transition-colors",
	},
	...
	"py-1 absolute right-0 bg-blue-500 rounded-tl-md px-2 text-xs text-white bottom-0": twerge.CacheValue{
		Generated: "tw-49",
		Merged:    "bg-blue-500 text-xs text-white py-1 absolute rounded-tl-md px-2 bottom-0 right-0",
	},
	"py-2 bg-gray-700 focus:outline-none border-gray-600 w-full focus:ring-green-500 border px-4 text-white rounded-md focus:ring-2": twerge.CacheValue{
		Generated: "tw-65",
		Merged:    "focus:outline-none rounded-md border focus:ring-2 py-2 border-gray-600 text-white w-full px-4 bg-gray-700 focus:ring-green-500",
	},
	"py-3 text-gray-900 rounded-md hover:opacity-90 font-medium transition-opacity bg-white px-6": twerge.CacheValue{
		Generated: "tw-20",
		Merged:    "bg-white hover:opacity-90 transition-opacity font-medium px-6 py-3 text-gray-900 rounded-md",
	},
	...
	"rounded-full bg-blue-600 relative mx-auto shadow-lg": twerge.CacheValue{
		Generated: "tw-25",
		Merged:    "bg-blue-600 rounded-full relative mx-auto shadow-lg",
	},
	"rounded-md font-medium text-white transition-colors focus:ring-offset-2 focus:ring-2 focus:ring-green-500 w-full hover:bg-green-700 bg-green-600 py-3 focus:outline-none px-6": twerge.CacheValue{
		Generated: "tw-66",
		Merged:    "w-full bg-green-600 text-white focus:ring-green-500 focus:ring-offset-2 transition-colors focus:ring-2 py-3 px-6 focus:outline-none rounded-md font-medium hover:bg-green-700",
	},
	...
	"text-base text-gray-300 hover:bg-gray-700 hover:text-white pl-3 pr-4 block py-2 font-medium": twerge.CacheValue{
		Generated: "tw-10",
		Merged:    "text-base text-gray-300 hover:bg-gray-700 hover:text-white py-2 font-medium pl-3 pr-4 block",
	},
	...
	"text-sm px-3 items-center hover:underline bg-emerald-800 w-full transition-colors py-1 hover:bg-emerald-600 h-8 rounded-sm justify-between font-medium text-emerald-300 hover:text-white flex flex-row": twerge.CacheValue{
		Generated: "tw-40",
		Merged:    "px-3 hover:underline transition-colors rounded-sm justify-between hover:text-white bg-emerald-800 flex items-center w-full py-1 font-medium hover:bg-emerald-600 flex-row text-emerald-300 h-8 text-sm",
	},
	...
	"text-xs bg-red-500 py-1 bottom-0 px-2 rounded-tr-md text-gray-200 left-0 absolute": twerge.CacheValue{
		Generated: "tw-42",
		Merged:    "bg-red-500 py-1 bottom-0 px-2 rounded-tr-md text-gray-200 left-0 absolute text-xs",
	},
	"w-full focus:outline-none border rounded-md pr-4 py-2 pl-10 bg-gray-700 text-white focus:ring-2 border-gray-600 focus:ring-green-500": twerge.CacheValue{
		Generated: "tw-83",
		Merged:    "border-gray-600 focus:ring-green-500 pl-10 bg-gray-700 border w-full rounded-md focus:outline-none pr-4 py-2 text-white focus:ring-2",
	},
	...
	"z-0 absolute h-16 bg-pink-600 -top-4 rounded-full -left-4 w-16": twerge.CacheValue{
		Generated: "tw-27",
		Merged:    "absolute z-0 -top-4 h-16 bg-pink-600 rounded-full -left-4 w-16",
	},
}
