...
export const Route = createFileRoute('/employments/')({
  component: EmploymentsPage,
  loader: async () => {
    const employments = await getExperience();
    return { employments };
  },
});
            ...
            <div class="space-y-8">
              <For each={data().employments}>
                {(employment) => (
                  ...
                  >
                    <a
                      href={`/employments/${employment.slug?.current}`}
                    ...
                    >
                      <div class="flex items-start gap-6">
                        ...
                        <div class="w-16 h-16 bg-linear-to-br from-green-500 to-green-700 rounded-full flex items-center justify-center text-white text-2xl font-bold flex-shrink-0 md:ml-12">
